                    ...
                    <div class="col-auto">
                        <div class="page-utilities">
                            <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                                <div class="col-auto">
                                    <a class="btn app-btn-primary" href="/dashboard/regis-supplier/create">
                                        ...
                                        <tbody>
                                            @foreach ($suppliers as $key => $supplier)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/dashboard/regis-supplier/{{ $supplier->id }}/edit"
                                                        ...
                                                        <form action="/dashboard/regis-supplier/{{ $supplier->id }}"
