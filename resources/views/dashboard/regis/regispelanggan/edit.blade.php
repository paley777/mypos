            ...
            <div class="container-xl">
                ...
                <div class="app-card app-card-notification shadow-sm mb-4">
                    ...
                    <div class="app-card-body p-4">
                        <form class="row g-2" method="post" action="/dashboard/regis-pelanggan/{{ $pelanggan->id }}">
                            @method('put')
                            @csrf
                            ...
                            <div class="col-md-3 position-relative">
                                ...
                                <input type="tel" id="validationCustom01" class="form-control" name="no_tlp"
                                    value="{{ old('no_tlp', $pelanggan->no_tlp) }}" placeholder="Isi Nomor Telepon" required>
                            </div>
                            <div class="col-md-12 position-relative">
                                ...
                                <input type="text" id="validationCustom01" class="form-control" name="alamat"
                                    value="{{ old('alamat', $pelanggan->alamat) }}" placeholder="Isi Alamat" required>
                            </div>
                            <p>
