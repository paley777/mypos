                    ...
                    <div class="col-12 col-lg-4">
                        <div class="app-card app-card-stat shadow-sm h-100">
                            <div class="app-card-body p-3 p-lg-4">
                                ...
                                <div class="stats-figure">{{ $total_barangmasuk }}</div>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="app-card app-card-stat shadow-sm h-100">
                            <div class="app-card-body p-3 p-lg-4">
                                ...
                                <div class="stats-figure">{{ $total_barangkeluar }}</div>
                            </div><!--//app-card-body-->
                            <a class="app-card-link-mask" href="#"></a>
                        </div><!--//app-card-->
                    </div><!--//col-->
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
                            ...
                            <div class="app-card-body px-4">
                                <div class="intro">Mengelola arus barang yang keluar dari manajemen stok barang.</div>
                            </div><!--//app-card-body-->
                            <div class="app-card-footer p-4 mt-auto">
                                <a class="btn app-btn-secondary" href="/dashboard/barang-keluar">Akses Fitur</a>
                            </div><!--//app-card-footer-->
                        </div><!--//app-card-->
                    </div><!--//col-->
                    <div class="col-12 col-lg-4">
                        <div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
                            ...
                            <div class="app-card-body px-4">
                                <div class="intro">Mengelola stok barang yang ada di manajemen stok barang.</div>
                            </div><!--//app-card-body-->
                            <div class="app-card-footer p-4 mt-auto">
