                ...
                <div class="app-card-header px-4 py-3">
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-12 col-lg-auto text-center text-lg-start">
                            ...
                            <h4 class="notification-title mb-1">Formulir Ubah Barang Masuk</h4>
                ...
                <div class="app-card-body p-4">
                    <form class="row g-2" method="post" action="/dashboard/barang-masuk/{{ $barangmasuk->id }}">
                        ...
                        <div class="col-md-4 position-relative">
                            ...
                            <input type="text" class="form-control" name="nama_penerima" placeholder="Isi Nama Penerima"
                                value="{{ $barangmasuk->nama_penerima }}" readonly required>
                        </div>
                        <div class="col-md-4 position-relative">
                            ...
                            <select class="" name="nama_supplier" required>
                                ...
                                @foreach ($suppliers as $supplier)
                                    <option value="{{ $supplier->nama }}" {{ $supplier->nama == $barangmasuk->nama_supplier ? 'selected' : '' }}>
                                        {{ $supplier->nama }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-4 position-relative">
                            ...
                            <select class="" name="nama_barang" required>
                                ...
                                @foreach ($barangs as $barang)
                                    <option value="{{ $barang->nama_barang }}" {{ $barang->nama_barang == $barangmasuk->nama_barang ? 'selected' : '' }}>
                                        {{ $barang->nama_barang }} |
                                        {{ $barang->satuan }}
                                    </option>
                                @endforeach
                        ...
                        <div class="col-md-4 position-relative">
                            ...
                            <select class="form-select" name="status" id="status" required>
                                ...
                                <option value="HUTANG" {{ $barangmasuk->status == 'HUTANG' ? 'selected' : '' }}>HUTANG
                                </option>
                            </select>
                        </div>
